...
/* harmony import */ var _mock_categories__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./mock.categories */ "./src/app/shared/services/mock.categories.ts");
...
let CategoryService = class CategoryService {
    ...
    getAll() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const c = this.localStorageService.get('Category', _mock_categories__WEBPACK_IMPORTED_MODULE_4__["CATEGORIES"]);
            return {
                targetUrl: '',
                result: c,
                success: true,
    ...
    get(id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const cat = this.localStorageService.get('Category', _mock_categories__WEBPACK_IMPORTED_MODULE_4__["CATEGORIES"]);
            for (const c of cat) {
                if (id == c.id) {
                    return {
                        targetUrl: '',
    ...
    insertSubCategory(category) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (this.isUniqueName(category)) {
                let data = yield this.get(category.id);
                if (data.success) {
                    let cat = data.result;
...
//# sourceMappingURL=default~routes-add-category-add-category-module~routes-category-list-category-list-module-es2015.js.map